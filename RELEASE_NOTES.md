# GeniusFocusView 1.0.0 — First public macOS test release

This is the first public community build of GeniusFocusView: an offline tool for understanding software projects and preparing structured context for humans and AI.

## Included

- local project analysis without an online AI service;
- detected files, objects, relations, systems, and subsystems;
- interactive project and detail maps;
- Visual Canvas Studio;
- structured `GeniusFocusView.md` export;
...
# GeniusFocusView 1.0.0 — Erster öffentlicher macOS-Testrelease

Dies ist der erste öffentliche Community-Build von GeniusFocusView: einem Offline-Werkzeug zum Verstehen von Softwareprojekten und zum Erzeugen strukturierten Kontexts für Menschen und KI.
...
SHA-256: `6ea8c82aba84d28ec2043f9ab3d27c08240969d156b20a76f568904041502053`
